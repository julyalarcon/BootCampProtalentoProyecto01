...
public class CategoriaImp implements ICategoria{
	...
	public boolean insertar(Categoria categoria) {
		...
		try {
			if (null == preparedStatementInsertar) {
				preparedStatementInsertar = administradorDeConexionMariaDB.getConexion().prepareStatement(sql, PreparedStatement.RETURN_GENERATED_KEYS);
			}
	...
	public static void main(String[] args) {
		...
		Categoria categoria = new Categoria(2L, "Casuales");
		
		System.out.println(categoria);
		
		//System.out.println(categoriaImp.insertar(categoria));
		
		System.out.println(categoria);
		
		System.out.println(categoriaImp.modificar(categoria));
		
		System.out.println(categoriaImp.eliminar(categoria));
		
		System.out.println(categoriaImp.buscarPorID(1l));
	}
