	...
	public boolean actualizarFechaUltimoAcceso(Usuario usuario) {
		...
		try {
			if (null == preparedStatementActualizarFechaUltimoAcceso) {
				preparedStatementActualizarFechaUltimoAcceso = administradorDeConexionMariaDB.getConexion().prepareStatement(sql);
			}
	...
	public boolean actualizarIntentoFallido(Usuario usuario) {
		...
		try {
			if (null == preparedStatementActualizarIntentoFallido) {
				preparedStatementActualizarIntentoFallido = administradorDeConexionMariaDB.getConexion().prepareStatement(sql);
			}
